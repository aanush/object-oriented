...
public final class FutureValueCacheFactoryImpl<K, V> implements FutureValueCacheFactory<K, V> {
    ...
    @Override
    public FutureValueCache<K, V> createSynchronizedFutureValueCache(int cacheSize, Function<K, V> cacheFunction) {
        return new SynchronizedFutureValueCache<>(cacheSize, cacheFunction);
    }

    private final class SynchronizedFutureValueCache<K, V> implements FutureValueCache<K, V> {
